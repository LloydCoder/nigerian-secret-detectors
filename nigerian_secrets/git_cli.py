...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("repository", help="Git repository to scan")
    parser.add_argument("--max-commits", type=int, default=200)
    parser.add_argument("--max-files-per-commit", type=int, default=200)
    parser.add_argument(
        "--fingerprint-key-env",
        default="NIGERIAN_FINGERPRINT_KEY",
        help="Environment variable containing the HMAC correlation key",
    )
